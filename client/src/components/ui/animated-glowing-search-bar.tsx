  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[50px] max-w-[250px] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[48px] max-w-[248px] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[46px] max-w-[245px] rounded-lg blur-[2px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[44px] max-w-[243px] rounded-xl blur-[0.5px] 
        ...
        <div id="main" className="relative group">
          ...
          <div id="filter-icon" className="absolute top-1 right-1 flex items-center justify-center z-[2] max-h-8 max-w-[30px] h-full w-full [isolation:isolate] overflow-hidden rounded-lg bg-gradient-to-b from-[#161329] via-black to-[#1d1b4b] border border-transparent">
          ...
          <div id="search-icon" className="absolute left-4 top-[9px]">
